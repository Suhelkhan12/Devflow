...
const QuestionCard = ({ id, title, author, createdAt, upvotes, downvotes, totalAnswers, views, tags }: Question) => {
  return (
    <div className="card-wrapper hover:shadow-primary-500/30 relative z-10 rounded-[10px] border p-4 transition duration-300 hover:shadow-md sm:px-5 sm:py-4 md:p-6 dark:border-0">
